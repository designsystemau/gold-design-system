					...
					<AUfooterEnd>
						<div className="row">
							<div className="col-sm-12">
								...
								<p><small>&copy; Commonwealth of Australia, <a href="https://github.com/designsystemau/gold-design-system/blob/main/LICENSE.md" rel="external license">MIT licensed</a></small></p>
							</div>
						</div>
					</AUfooterEnd>
				</div>
